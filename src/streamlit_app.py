...
def generate_response(input_text: str, db_type: str, cache: Cache, guard: gd.Guard) -> None:
    """
...
def main() -> None:
    ...
    with st.form("my_form"):
        ...
        if submitted:
            generate_response(text, db_type, cache, guard)
    
    st.warning("SQL Code Generator is in beta and may make mistakes.")
